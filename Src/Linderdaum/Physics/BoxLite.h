...
struct Body
{
	Body(): position(0,0), rotation(0), velocity(0,0), angularVelocity(0), force(0,0), torque(0) { Set(Vec2(1.0f, 1.0f), FLT_MAX); }
...
struct World
{
	World(Vec2 _gravity, int _iterations) : gravity(_gravity), iterations(_iterations) {}
