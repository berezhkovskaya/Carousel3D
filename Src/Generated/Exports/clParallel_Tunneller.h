/**
 * \file clParallel_Tunneller.h
 * \brief Tunneller for class: clParallel
 * \version 0.6.06
 * \date 16/01/2012
...
#ifndef _clParallel_Tunneller_
#define _clParallel_Tunneller_

#include "Linderdaum/World/AI/Behaviour.h"

#if !defined( _DISABLE_TUNNELLERS_ )

class clParallel_Tunneller: public clParallel
{
public:
   //
   // iObject interface
   ...
   virtual void    DumpDot(iOStream* P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "DumpDot" ) )
      {
         ...
         if ( !MethodCalled ) clParallel::DumpDot(P0);

         return;
      }

      clParallel::DumpDot(P0);
   }
