/**
 * \file clGUIWindow_Tunneller.h
 * \brief Tunneller for class: clGUIWindow
 * \version 0.6.06
 * \date 16/01/2012
...
//                             Base class: clGUIDialogWindow  (public)

#ifndef _clGUIWindow_Tunneller_
#define _clGUIWindow_Tunneller_

#include "Linderdaum/GUI/ComCtl/I_Window.h"

#if !defined( _DISABLE_TUNNELLERS_ )

class clGUIWindow_Tunneller: public clGUIWindow
{
public:
   //
   // iObject interface
   ...
   virtual bool    Event_Key(iGUIResponder* P0, const int P1, const bool P2)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "Event_Key" ) )
      {
         ...
         if ( !MethodCalled ) return clGUIPanel::Event_Key(P0, P1, P2);

         return *(TypeTraits< bool >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIPanel::Event_Key(P0, P1, P2);
   }
   ...
   virtual void    Event_Registered(iGUIResponder* P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "Event_Registered" ) )
      {
         ...
         if ( !MethodCalled ) clGUIWindow::Event_Registered(P0);

         return;
      }

      clGUIWindow::Event_Registered(P0);
   }
   ...
   virtual void    Event_Timer(iGUIResponder* P0, float P1)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "Event_Timer" ) )
      {
         ...
         if ( !MethodCalled ) clGUIWindow::Event_Timer(P0, P1);

         return;
      }

      clGUIWindow::Event_Timer(P0, P1);
   }
   ...
   virtual void    Event_MouseInside(iGUIResponder* P0, const LVector2& P1)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "Event_MouseInside" ) )
      {
         ...
         if ( !MethodCalled ) clGUIWindow::Event_MouseInside(P0, P1);

         return;
      }

      clGUIWindow::Event_MouseInside(P0, P1);
   }
   virtual void    Event_MouseOutside(iGUIResponder* P0, const LVector2& P1)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "Event_MouseOutside" ) )
      {
         ...
         if ( !MethodCalled ) clGUIWindow::Event_MouseOutside(P0, P1);

         return;
      }

      clGUIWindow::Event_MouseOutside(P0, P1);
   }
   virtual void    Event_MouseLeft(iGUIResponder* P0, const LVector2& P1, const bool P2)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "Event_MouseLeft" ) )
      {
         ...
         if ( !MethodCalled ) clGUIWindow::Event_MouseLeft(P0, P1, P2);

         return;
      }

      clGUIWindow::Event_MouseLeft(P0, P1, P2);
   }
   ...
   virtual void    Event_LDoubleClick(iGUIResponder* P0, const LVector2& P1)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "Event_LDoubleClick" ) )
      {
         ...
         if ( !MethodCalled ) clGUIDialogWindow::Event_LDoubleClick(P0, P1);

         return;
      }

      clGUIDialogWindow::Event_LDoubleClick(P0, P1);
   }
   ...
   virtual void    Event_PageActive(iGUIResponder* P0, clGUIPage* P1)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "Event_PageActive" ) )
      {
         ...
         if ( !MethodCalled ) iGUIResponder::Event_PageActive(P0, P1);

         return;
      }

      iGUIResponder::Event_PageActive(P0, P1);
   }
   virtual void    Event_PageInactive(iGUIResponder* P0, clGUIPage* P1)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "Event_PageInactive" ) )
      {
         ...
         if ( !MethodCalled ) iGUIResponder::Event_PageInactive(P0, P1);

         return;
      }

      iGUIResponder::Event_PageInactive(P0, P1);
   }
   ...
   virtual bool    ContainsCaption(const LVector2& P0) const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "ContainsCaption" ) )
      {
         ...
         if ( !MethodCalled ) return clGUIWindow::ContainsCaption(P0);

         return *(TypeTraits< bool >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIWindow::ContainsCaption(P0);
   }
   virtual bool    ContainsResizeCorner(const LVector2& P0) const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "ContainsResizeCorner" ) )
      {
         ...
         if ( !MethodCalled ) return clGUIWindow::ContainsResizeCorner(P0);

         return *(TypeTraits< bool >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIWindow::ContainsResizeCorner(P0);
   }
   virtual bool    ContainsCloseButton(const LVector2& P0) const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "ContainsCloseButton" ) )
      {
         ...
         if ( !MethodCalled ) return clGUIWindow::ContainsCloseButton(P0);

         return *(TypeTraits< bool >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIWindow::ContainsCloseButton(P0);
   }
...
public:
   ...
   virtual void    PreRender()
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "PreRender" ) )
      {
         ...
         if ( !MethodCalled ) clGUIWindow::PreRender();

         return;
      }

      clGUIWindow::PreRender();
   }
   virtual void    PostRender()
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "PostRender" ) )
      {
         ...
         if ( !MethodCalled ) clGUIDialogWindow::PostRender();
   ...
   virtual bool    IsPage() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "IsPage" ) )
      {
         ...
         if ( !MethodCalled ) return iGUIView::IsPage();

         return *(TypeTraits< bool >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return iGUIView::IsPage();
   }
   virtual bool    IsViewDockable() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "IsViewDockable" ) )
      {
         ...
         if ( !MethodCalled ) return clGUIDialogWindow::IsViewDockable();

         return *(TypeTraits< bool >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIDialogWindow::IsViewDockable();
   }
   virtual bool    IsViewDraggable() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "IsViewDraggable" ) )
      {
         ...
         if ( !MethodCalled ) return clGUIDialogWindow::IsViewDraggable();

         return *(TypeTraits< bool >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIDialogWindow::IsViewDraggable();
   }
   virtual bool    IsViewSizeable() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "IsViewSizeable" ) )
      {
         ...
         if ( !MethodCalled ) return clGUIDialogWindow::IsViewSizeable();

         return *(TypeTraits< bool >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIDialogWindow::IsViewSizeable();
   }
   ...
   virtual bool    IsPageActive() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "IsPageActive" ) )
      {
         ...
         if ( !MethodCalled ) return iGUIView::IsPageActive();

         return *(TypeTraits< bool >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return iGUIView::IsPageActive();
   }
   ...
   virtual void    RenderHierarchy()
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "RenderHierarchy" ) )
      {
         ...
         if ( !MethodCalled ) iGUIView::RenderHierarchy();
   ...
   //
   // clGUIPanel interface
   //
   virtual void    SetBevelRadius(float P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetBevelRadius" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetBevelRadius", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetBevelRadius(P0);

         return;
      }

      clGUIPanel::SetBevelRadius(P0);
   }
   virtual void    SetShader(clRenderState* P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetShader" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetShader", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetShader(P0);

         return;
      }

      clGUIPanel::SetShader(P0);
   }
   virtual clRenderState*    GetShader() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "GetShader" ) )
      {
         clParametersList Params;

         bool MethodCalled = iObject::CallMethod( "GetShader", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) return clGUIPanel::GetShader();

         return *(TypeTraits< clRenderState* >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIPanel::GetShader();
   }
   virtual void    SetShaderName(const LString& P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetShaderName" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetShaderName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetShaderName(P0);

         return;
      }

      clGUIPanel::SetShaderName(P0);
   }
   virtual void    SetImage(clImage* P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetImage" ) )
      {
         clParametersList Params;

         ParameterType<clImage*>::Type Param0;

         Param0.ReadValue( &P0 );

         Params.push_back( &Param0 );

         bool MethodCalled = iObject::CallMethod( "SetImage", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetImage(P0);

         return;
      }

      clGUIPanel::SetImage(P0);
   }
   virtual void    SetImageName(const LString& P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetImageName" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetImageName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetImageName(P0);

         return;
      }

      clGUIPanel::SetImageName(P0);
   }
   virtual LString    GetShaderName() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "GetShaderName" ) )
      {
         clParametersList Params;

         bool MethodCalled = iObject::CallMethod( "GetShaderName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) return clGUIPanel::GetShaderName();

         return *(TypeTraits< LString >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIPanel::GetShaderName();
   }
   virtual LString    GetImageName() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "GetImageName" ) )
      {
         clParametersList Params;

         bool MethodCalled = iObject::CallMethod( "GetImageName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) return clGUIPanel::GetImageName();

         return *(TypeTraits< LString >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIPanel::GetImageName();
   }
   virtual void    SetShaderMouseOver(clRenderState* P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetShaderMouseOver" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetShaderMouseOver", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetShaderMouseOver(P0);

         return;
      }

      clGUIPanel::SetShaderMouseOver(P0);
   }
   virtual clRenderState*    GetShaderMouseOver() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "GetShaderMouseOver" ) )
      {
         clParametersList Params;

         bool MethodCalled = iObject::CallMethod( "GetShaderMouseOver", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) return clGUIPanel::GetShaderMouseOver();

         return *(TypeTraits< clRenderState* >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIPanel::GetShaderMouseOver();
   }
   virtual void    SetShaderMouseOverName(const LString& P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetShaderMouseOverName" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetShaderMouseOverName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetShaderMouseOverName(P0);

         return;
      }

      clGUIPanel::SetShaderMouseOverName(P0);
   }
   virtual void    SetImageMouseOver(clImage* P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetImageMouseOver" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetImageMouseOver", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetImageMouseOver(P0);

         return;
      }

      clGUIPanel::SetImageMouseOver(P0);
   }
   virtual void    SetImageMouseOverName(const LString& P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetImageMouseOverName" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetImageMouseOverName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetImageMouseOverName(P0);

         return;
      }

      clGUIPanel::SetImageMouseOverName(P0);
   }
   virtual LString    GetShaderMouseOverName() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "GetShaderMouseOverName" ) )
      {
         clParametersList Params;

         bool MethodCalled = iObject::CallMethod( "GetShaderMouseOverName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) return clGUIPanel::GetShaderMouseOverName();

         return *(TypeTraits< LString >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIPanel::GetShaderMouseOverName();
   }
   virtual LString    GetImageMouseOverName() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "GetImageMouseOverName" ) )
      {
         clParametersList Params;

         bool MethodCalled = iObject::CallMethod( "GetImageMouseOverName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) return clGUIPanel::GetImageMouseOverName();

         return *(TypeTraits< LString >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIPanel::GetImageMouseOverName();
   }
   virtual void    SetShaderSwitchedOn(clRenderState* P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetShaderSwitchedOn" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetShaderSwitchedOn", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetShaderSwitchedOn(P0);

         return;
      }

      clGUIPanel::SetShaderSwitchedOn(P0);
   }
   virtual clRenderState*    GetShaderSwitchedOn() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "GetShaderSwitchedOn" ) )
      {
         clParametersList Params;

         bool MethodCalled = iObject::CallMethod( "GetShaderSwitchedOn", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) return clGUIPanel::GetShaderSwitchedOn();

         return *(TypeTraits< clRenderState* >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIPanel::GetShaderSwitchedOn();
   }
   virtual void    SetShaderSwitchedOnName(const LString& P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetShaderSwitchedOnName" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetShaderSwitchedOnName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetShaderSwitchedOnName(P0);

         return;
      }

      clGUIPanel::SetShaderSwitchedOnName(P0);
   }
   virtual void    SetImageSwitchedOn(clImage* P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetImageSwitchedOn" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetImageSwitchedOn", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetImageSwitchedOn(P0);

         return;
      }

      clGUIPanel::SetImageSwitchedOn(P0);
   }
   virtual void    SetImageSwitchedOnName(const LString& P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetImageSwitchedOnName" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetImageSwitchedOnName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetImageSwitchedOnName(P0);

         return;
      }

      clGUIPanel::SetImageSwitchedOnName(P0);
   }
   virtual LString    GetShaderSwitchedOnName() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "GetShaderSwitchedOnName" ) )
      {
         clParametersList Params;

         bool MethodCalled = iObject::CallMethod( "GetShaderSwitchedOnName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) return clGUIPanel::GetShaderSwitchedOnName();

         return *(TypeTraits< LString >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIPanel::GetShaderSwitchedOnName();
   }
   virtual LString    GetImageSwitchedOnName() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "GetImageSwitchedOnName" ) )
      {
         clParametersList Params;

         bool MethodCalled = iObject::CallMethod( "GetImageSwitchedOnName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) return clGUIPanel::GetImageSwitchedOnName();

         return *(TypeTraits< LString >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIPanel::GetImageSwitchedOnName();
   }
   virtual void    SetHook(const clHookProc& P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetHook" ) )
      {
         clParametersList Params;

         ParameterType<const clHookProc&>::Type Param0;

         Param0.ReadValue( &P0 );

         Params.push_back( &Param0 );

         bool MethodCalled = iObject::CallMethod( "SetHook", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetHook(P0);

         return;
      }

      clGUIPanel::SetHook(P0);
   }
   virtual void    SetUniformsV(const LVector4& P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetUniformsV" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetUniformsV", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIPanel::SetUniformsV(P0);

         return;
      }

      clGUIPanel::SetUniformsV(P0);
   }
   //
   // clGUIDialogWindow interface
   //
   virtual void    SetWindowComposerShaderName(const LString& P0)
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "SetWindowComposerShaderName" ) )
      {
         clParametersList Params;
         ...
         bool MethodCalled = iObject::CallMethod( "SetWindowComposerShaderName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) clGUIDialogWindow::SetWindowComposerShaderName(P0);

         return;
      }

      clGUIDialogWindow::SetWindowComposerShaderName(P0);
   }
   virtual LString    GetWindowComposerShaderName() const
   {
      if ( !iObject::FInheritedCall && iObject::IsMethodOverriden( "GetWindowComposerShaderName" ) )
      {
         clParametersList Params;

         bool MethodCalled = iObject::CallMethod( "GetWindowComposerShaderName", Params, iObject::FInheritedCall );

         if ( !MethodCalled ) return clGUIDialogWindow::GetWindowComposerShaderName();

         return *(TypeTraits< LString >::ReferredType*)iObject::GetReturnValue()->GetNativeBlock();
      }

      return clGUIDialogWindow::GetWindowComposerShaderName();
   }
   //
   // clGUIWindow interface
   //
};
