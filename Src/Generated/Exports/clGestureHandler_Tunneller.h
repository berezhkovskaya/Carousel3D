/**
 * \file clGestureHandler_Tunneller.h
 * \brief Tunneller for class: clGestureHandler
 * \version 0.6.06
 * \date 16/01/2012
...
#ifndef _clGestureHandler_Tunneller_
#define _clGestureHandler_Tunneller_

#include "Linderdaum/Input/Gestures.h"

#if !defined( _DISABLE_TUNNELLERS_ )

class clGestureHandler_Tunneller: public clGestureHandler
{
public:
   //
   // iObject interface
