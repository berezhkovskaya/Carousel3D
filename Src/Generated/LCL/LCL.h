...
#include "ExtLibs/CL/cl_platform.h"

#ifdef __cplusplus
extern "C" {
#endif

// user defined typedefs go here
...
#define CL_PROFILING_COMMAND_END                    0x1283
	...
	extern PFNclGetPlatformIDs*                  clGetPlatformIDs;
	extern PFNclGetPlatformInfo*                 clGetPlatformInfo;
	extern PFNclGetDeviceIDs*                    clGetDeviceIDs;
	extern PFNclGetDeviceInfo*                   clGetDeviceInfo;
	extern PFNclCreateContext*                   clCreateContext;
	extern PFNclCreateContextFromType*           clCreateContextFromType;
	extern PFNclRetainContext*                   clRetainContext;
	extern PFNclReleaseContext*                  clReleaseContext;
	extern PFNclGetContextInfo*                  clGetContextInfo;
	extern PFNclCreateCommandQueue*              clCreateCommandQueue;
	extern PFNclRetainCommandQueue*              clRetainCommandQueue;
	extern PFNclReleaseCommandQueue*             clReleaseCommandQueue;
	extern PFNclGetCommandQueueInfo*             clGetCommandQueueInfo;
	extern PFNclSetCommandQueueProperty*         clSetCommandQueueProperty;
	extern PFNclCreateBuffer*                    clCreateBuffer;
	extern PFNclCreateImage2D*                   clCreateImage2D;
	extern PFNclCreateImage3D*                   clCreateImage3D;
	extern PFNclRetainMemObject*                 clRetainMemObject;
	extern PFNclReleaseMemObject*                clReleaseMemObject;
	extern PFNclGetSupportedImageFormats*        clGetSupportedImageFormats;
	extern PFNclGetMemObjectInfo*                clGetMemObjectInfo;
	extern PFNclGetImageInfo*                    clGetImageInfo;
	extern PFNclCreateSampler*                   clCreateSampler;
	extern PFNclRetainSampler*                   clRetainSampler;
	extern PFNclReleaseSampler*                  clReleaseSampler;
	extern PFNclGetSamplerInfo*                  clGetSamplerInfo;
	extern PFNclCreateProgramWithSource*         clCreateProgramWithSource;
	extern PFNclCreateProgramWithBinary*         clCreateProgramWithBinary;
	extern PFNclRetainProgram*                   clRetainProgram;
	extern PFNclReleaseProgram*                  clReleaseProgram;
	extern PFNclBuildProgram*                    clBuildProgram;
	extern PFNclUnloadCompiler*                  clUnloadCompiler;
	extern PFNclGetProgramInfo*                  clGetProgramInfo;
	extern PFNclGetProgramBuildInfo*             clGetProgramBuildInfo;
	extern PFNclCreateKernel*                    clCreateKernel;
	extern PFNclCreateKernelsInProgram*          clCreateKernelsInProgram;
	extern PFNclRetainKernel*                    clRetainKernel;
	extern PFNclReleaseKernel*                   clReleaseKernel;
	extern PFNclSetKernelArg*                    clSetKernelArg;
	extern PFNclGetKernelInfo*                   clGetKernelInfo;
	extern PFNclGetKernelWorkGroupInfo*          clGetKernelWorkGroupInfo;
	extern PFNclWaitForEvents*                   clWaitForEvents;
	extern PFNclGetEventInfo*                    clGetEventInfo;
	extern PFNclRetainEvent*                     clRetainEvent;
	extern PFNclReleaseEvent*                    clReleaseEvent;
	extern PFNclGetEventProfilingInfo*           clGetEventProfilingInfo;
	extern PFNclFlush*                           clFlush;
	extern PFNclFinish*                          clFinish;
	extern PFNclEnqueueReadBuffer*               clEnqueueReadBuffer;
	extern PFNclEnqueueWriteBuffer*              clEnqueueWriteBuffer;
	extern PFNclEnqueueCopyBuffer*               clEnqueueCopyBuffer;
	extern PFNclEnqueueReadImage*                clEnqueueReadImage;
	extern PFNclEnqueueWriteImage*               clEnqueueWriteImage;
	extern PFNclEnqueueCopyImage*                clEnqueueCopyImage;
	extern PFNclEnqueueCopyImageToBuffer*        clEnqueueCopyImageToBuffer;
	extern PFNclEnqueueCopyBufferToImage*        clEnqueueCopyBufferToImage;
	extern PFNclEnqueueMapBuffer*                clEnqueueMapBuffer;
	extern PFNclEnqueueMapImage*                 clEnqueueMapImage;
	extern PFNclEnqueueUnmapMemObject*           clEnqueueUnmapMemObject;
	extern PFNclEnqueueNDRangeKernel*            clEnqueueNDRangeKernel;
	extern PFNclEnqueueTask*                     clEnqueueTask;
	extern PFNclEnqueueNativeKernel*             clEnqueueNativeKernel;
	extern PFNclEnqueueMarker*                   clEnqueueMarker;
	extern PFNclEnqueueWaitForEvents*            clEnqueueWaitForEvents;
	extern PFNclEnqueueBarrier*                  clEnqueueBarrier;
	extern PFNclGetExtensionFunctionAddress*     clGetExtensionFunctionAddress;


	namespace LCL
	{
		class clCLExtRetriever
		{
		public:
			//
			// clCLExtRetriever
